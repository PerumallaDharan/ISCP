...
# (the delimiter), use split() to get the separate values in the
# form of a list. The delimiter is space (ascii 32) by default. To
# specify that comma is the delimiter, use string.split(','). For
# this challenge, and in general on HackerRank, space will be the delimiter.
...
# >> print (newlis)
# [5, 4, 3, 2]
# Sets are an unordered collection of unique values. A single set
...
# Task
# Given  sets of integers,  and , print their symmetric difference in
