...
# When printed, iterated or converted into a sequence, its
...
# set([(6, 'r'), (7, 'a'), (3, 'k'), (4, 'e'), (5, 'r'),
# (9, 'k'), (2, 'c'), (0, 'H'), (1, 'a'), (8, 'n')])
# Basically, sets are used for membership testing and
...
# Here, set is the set containing the distinct heights. Using the sum()
# and len() functions, we can compute the average.
