...
# The .union() operator returns the union of a set and
# the set of elements in an iterable.
# Sometimes, the | operator is used in place of .union()
# operator, but it operates only on the set of elements in set.
...
# French newspaper. The same student could be in both sets. Your task
# is to find the total number of students who have subscribed to at least one newspaper.
